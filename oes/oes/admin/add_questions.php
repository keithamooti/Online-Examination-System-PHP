<?php 
	include 'db/db.php';
	function load_courseunit($con){
	 	$output = '';
	 	$query = "SELECT * FROM course_unit ORDER BY unit_name";
	 	$result = mysqli_query($con,$query);
	 	while ($row = mysqli_fetch_array($result)) {
	 		$output .= '<option value = "'.$row["unit_code"].'">'.$row["unit_name"].'</option>';
	 	}
	 	return $output;
	} 
?>
							...
							<div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title"><h5 class="text-white op-7 mb-4">Add new Test.</h5></div>
								...
								<div class="card-body">
									<div class="row">
										<span style="margin-left:30%;font-size:30px;"><b>Enter Test Details</b></span><br /><br />
										...
										<div class="col-md-6" style="margin-left:23%;">   
											...
											<div class="form-group">
											  ...
											  <div class="col-md-12">
											  <input id="name" name="name" placeholder="Enter Test title" class="form-control input-md" type="text" required="true">
											    
											  </div>
											</div>
											<div class="form-group">
											  <label class="col-md-12 control-label" for="cunit"></label>  
											  <div class="col-md-12">
											  <select name="cunit" id="cunit" class="form-control" required="true">
											...
											<div class="form-group">
											  ...
											  <div class="col-md-12">
											  <input id="right" name="right" placeholder="Enter marks on right answer" class="form-control input-md" min="0" type="number" required="true">
											...
											<div class="form-group">
											  ...
											  <div class="col-md-12">
											  <input id="wrong" name="wrong" placeholder="Enter minus marks on wrong answer without sign" class="form-control input-md" min="0" type="number" required="true">
											...
											<div class="form-group">
											  ...
											  <div class="col-md-12">
											  <input id="time" name="time" placeholder="Enter time limit for test in minute" class="form-control input-md" min="1" type="number" required="true">
											...
											<div class="form-group">
											  ...
											  <div class="col-md-12"> 
											    <input  type="submit" style="margin-left:45%" class="btn btn-primary" value="Submit" name="add_test" class="btn btn-primary"/>
											  </div>
											</div>
