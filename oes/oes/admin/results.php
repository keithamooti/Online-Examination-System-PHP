		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
					<div class="mt-2 mb-4">
						<h2 class="text-white pb-2">Results</h2>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<?php
										...
										$query = mysqli_query($con,"SELECT * FROM rank");
											...
											<tbody>
												<?php
													...
													while ($row = mysqli_fetch_array($query)) {
														...
														$id++;
														$email = $row['email'];
														$q = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM users WHERE email = '$email'"))

													?>
														<tr>
															<td><?php echo $id; ?></td> 
															<td><?php echo $q['name']; ?></td> 
															<td><?php echo $q['reg']; ?></td>
															<td><?php echo $row['score']; ?>%</td> 
															<td><a href="#"><i class="fas fa-eye" style=" font-size: 25px; align-content: center;"></i></a></td>
														</tr>
													<?php
